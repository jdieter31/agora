...
import (
	...
	appparams "github.com/jdieter31/agora/app/params"
	"github.com/jdieter31/agora/x/agora"
	agorakeeper "github.com/jdieter31/agora/x/agora/keeper"
	agoratypes "github.com/jdieter31/agora/x/agora/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/.agora")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	agoraKeeper agorakeeper.Keeper
...
func New(
	...
	app.agoraKeeper = *agorakeeper.NewKeeper(
        appCodec, keys[agoratypes.StoreKey], keys[agoratypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		agora.NewAppModule(appCodec, app.agoraKeeper),
